...
/**
 * Class InvalidStrictLessException
 *
 * @package KoKoKo\assert\exceptions
 */
class InvalidStrictLessException extends \InvalidArgumentException
{
    /**
    ...
    public function __construct($variableName, $variableValue, $number)
    {
        ...
        parent::__construct(
            sprintf(
                'Variable "$%s" must be strictly less than "%v", actual value: "%v"',
                $variableName,
                $number,
                $variableValue
            )
