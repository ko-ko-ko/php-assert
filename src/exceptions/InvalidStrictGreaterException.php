...
/**
 * Class InvalidStrictGreaterException
 *
 * @package KoKoKo\assert\exceptions
 */
class InvalidStrictGreaterException extends \InvalidArgumentException
{
    /**
    ...
    public function __construct($variableName, $variableValue, $number)
    {
        ...
        parent::__construct(
            sprintf(
                'Variable "$%s" must be strictly greater than "%v", actual value: "%v"',
                $variableName,
                $number,
                $variableValue
            )
