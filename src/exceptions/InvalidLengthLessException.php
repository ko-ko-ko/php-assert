...
/**
 * Class InvalidLengthLessException
 *
 * @package KoKoKo\assert\exceptions
 */
class InvalidLengthLessException extends \InvalidArgumentException
{
    /**
    ...
    public function __construct($variableName, $variableValue, $length)
    {
        ...
        parent::__construct(
            sprintf(
                'Variable "$%s" must have length less than "%d", actual length: "%d"',
                $variableName,
                $length,
