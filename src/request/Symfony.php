...
class Symfony implements RequestInterface
{
    ...
    public function get($name, $default = null)
    {
        ...
        if ($this->throwException) {
            return Cast::assert($this->request->get($name, $default), $name, $this->exceptionClass);
        }

        return Cast::validate($this->request->get($name, $default), $name, $this->skipOnErrors);
    }
    ...
    public function toFloat($name, $default = (float)0)
    {
        ...
        if ($this->throwException) {
            return Cast::assert($this->request->get($name, $default), $name, $this->exceptionClass)->toFloat($default);
        }

        return Cast::validate($this->request->get($name, $default), $name, $this->skipOnErrors)->toFloat($default);
    }
    ...
    public function toInt($name, $default = 0)
    {
        ...
        if ($this->throwException) {
            return Cast::assert($this->request->get($name, $default), $name, $this->exceptionClass)->toInt($default);
        }

        return Cast::validate($this->request->get($name, $default), $name, $this->skipOnErrors)->toInt($default);
    }
    ...
    public function toString($name, $default = '')
    {
        ...
        if ($this->throwException) {
            return Cast::assert($this->request->get($name, $default), $name, $this->exceptionClass)->toString($default);
        }

        return Cast::validate($this->request->get($name, $default), $name, $this->skipOnErrors)->toString($default);
    }
    ...
    public function toBool($name, $default = false)
    {
        ...
        if ($this->throwException) {
            return Cast::assert($this->request->get($name, $default), $name, $this->exceptionClass)->toBool($default);
        }

        return Cast::validate($this->request->get($name, $default), $name, $this->skipOnErrors)->toBool($default);
    }
}
